...
public class Input {
    ...
    public void inputDate() {
        File fileInput = new File("src/com/shpp/p2p/cs/yfurd/assignment14/test/smoke.bmp");
        File fileNewOutput = new File("src/com/shpp/p2p/cs/yfurd/assignment14/test/smoke.bmp.par");

        arch.archive(fileInput, fileNewOutput);
    }
